...
Reloj.timeStop = () => {
    ...
    console.log("Procesos iniciado a las ",dtIni, " - Tiempo transcurrido: ", Reloj.crono(dtIni,dtFin))
...
Reloj.timeCounter = () => {
  ...
  contador = setInterval( () => {
    ...
    console.log("Procesos iniciado a las ",dtIni, " - Tiempo transcurrido: ", dtDiff)
    }, 1000) 
}
...
Reloj.crono = (dtIni, dtFin) => {
    ...
    //document.body.innerHTML += "La diferencia es de: " + (t1.getHours() ? t1.getHours() + (t1.getHours() > 1 ? " horas" : " hora") : "") + (t1.getMinutes() ? ", " + t1.getMinutes() + " minutos" : "") + (t1.getSeconds() ? (t1.getHours() || t1.getMinutes() ? " y " : "") + t1.getSeconds() + " segundos" : "");
       return (t1.getHours() ? t1.getHours() + (t1.getHours() > 1 ? " horas" : " hora") : "") + (t1.getMinutes() ? ", " + t1.getMinutes() + " min" : "") + (t1.getSeconds() ? (t1.getHours() || t1.getMinutes() ? " y " : "") + t1.getSeconds() + " seg" : "")
    }
