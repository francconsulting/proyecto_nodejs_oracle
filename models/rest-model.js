 ...
 * @param {array} results
 */
RestModel.closeRs = (conn, results) => { 
 ...
 */
RestModel.ejecutarSqlPromise = (conn, ssql, params) => {
ConnBd.ejecutarSqlPromise = (conn, ssql, params) => {
   ...
   */
  RestModel.getAllRows = (conn, results, numRows) => {
   ...
   */
  RestModel.getCabecera = (conn, results) => {
